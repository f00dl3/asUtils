...
public class StumpJunk {
	...
	public static void varToFile(String thisVar, File outFile, boolean appendFlag) throws FileNotFoundException {
        ...
        public static void zipThisFolder(File sourceFolder, File outputZipFile) {
        ...
        private static void zipThisFolderWorker(File dirObj, ZipOutputStream zos) throws IOException {
        ...
        public static void zipThisFile(File fileToZip, File outputZipFile) {
            String zipFile = outputZipFile.toString();
